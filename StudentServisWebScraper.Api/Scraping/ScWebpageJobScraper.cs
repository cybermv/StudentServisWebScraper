...
namespace StudentServisWebScraper.Api.Scraping
{
    ...
    /// </summary>
    public class ScWebpageJobScraper : JobScraper
    {
        public ScWebpageJobScraper(ScraperConfiguration configuration) : base(configuration)
        {
        }
        ...
        public override ICollection<JobOfferInfo> Scrape()
        {
            ...
            {
                throw new ScrapingException($"Cannot load job offer page; cannot continue scraping.");
            }
